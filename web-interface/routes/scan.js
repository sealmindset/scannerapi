 ...
 * Scan Flow Routes
 * 
 * This module provides routes for the scan flow:
    ...
    router.post('/start', async (req, res) => {
        try {
            ...
            runIntegratedScanFlow({
                ...
                console.error('Error in scan flow:', error);
            ...
            console.error('Error starting scan flow:', error);
            res.status(500).json({
                success: false,
                error: error.message
            });
