...
console.log('2. Access http://localhost:3000/admin/prompts in your browser');
...
console.log('3. Start the server again: cd web-interface && PORT=3000 node app.js');
console.log('\nNote: The scanner web interface runs on port 3000, while the target API is on port 5002');
